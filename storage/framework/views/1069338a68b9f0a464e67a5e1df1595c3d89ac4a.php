        ...
        <div class="container">
            <div class="row">
                ...
                <?php if(Auth::guest()): ?>
                    ...
                    <div class="intro-text">
                        <b><h1><span class="name">Kategori Lembur</span></h1></b>
                        <hr class="star-light">
...
<br>
	 <div class="right_col" role="main">
          <div class="">
<center><h2>Data Kategori Lembur</h2></center>
                      ...
                      <tbody>
                         ...
                         <?php $__currentLoopData = $kategori; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                             <tr>
                                 ...
                                 <th><a title="Edit" href="<?php echo e(route('Kategori.edit',$data->id)); ?>" class="btn btn-warning"><i class="fa fa-edit">Edit</i></a></th>
                                 <th>
