        ...
        <div class="container">
            <div class="row">
                ...
                @if (Auth::guest())
                    ...
                    <div class="intro-text">
                        <h1><b><font face="Maiandro GD" color="white"><center>KATEGORI LEMBUR</center></font></b></h1>
                        <hr class="star-light">
...
<h1><b><font face="Maiandro GD" color="white"><center>Data Kategori Lembur</center></font></b></h1>
 ...
 <center><a href="{{url('Kategori/create')}}" class="btn btn-primary">Input Kategori Lembur<i class="fa fa-pencil"></i></a></center>
           <div class="row">
        <div class="col-md-8 col-md-offset-2">
                      ...
                      <tbody>
                         ...
                         @foreach ($kategori as $data)
                             <tr>
                                 ...
                                 <th><a title="Edit" href="{{route('Kategori.edit',$data->id)}}" class="btn btn-warning"><i class="fa fa-edit">Edit</i></a></th>
                                 <th>
